...
class Webshopapps_Desttype_Model_Shipping_Source_AdminAddressType
{
    public function toOptionArray() {
        $validation = Mage::getSingleton('desttype/shipping_desttype');
        $arr = array();
        foreach ($validation->getCode('address_type_admin_descr') as $k=>$v) {
