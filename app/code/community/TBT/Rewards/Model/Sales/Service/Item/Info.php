    ...
    extends Mage_Core_Model_Abstract
{
    ...
    {
        $rowSubtotal = Mage::helper('checkout')->getSubtotalInclTax($this->getItem())
            - $this->getItem()->getDiscountTaxCompensation()
            - $this->getItem()->getDiscountAmount();
    ...
    public function getRowSubtotalExclTax()
    {
        $rowSubtotal = Mage::helper('checkout')->getSubtotalInclTax($this->getItem())
            - $this->getItem()->getDiscountTaxCompensation()
            - $this->getItem()->getDiscountAmount();
        $rowSubtotal -= $this->getItem()->getTaxAmount();
