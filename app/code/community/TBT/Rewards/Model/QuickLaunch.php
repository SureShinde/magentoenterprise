...
class TBT_Rewards_Model_QuickLaunch
{
    ...
    public function saveSettings($data)
    {
        ...
        Mage::getConfig()->saveConfig('rewards/quickLaunch/loyaltyProgramData', serialize($data));
        Mage::getConfig()->cleanCache();
    ...
    public function launchProgram($data)
    {
        ...
        $loyaltyProgramSettings = unserialize($loyaltyProgramSettings);
        ...
        Mage::getConfig()->saveConfig('rewards/quickLaunch/loyaltyProgramData', '');
