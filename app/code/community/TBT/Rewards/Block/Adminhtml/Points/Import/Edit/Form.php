...
class TBT_Rewards_Block_Adminhtml_Points_Import_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('csvFile', 'file', array (
            ...
            'required'           => true,
            'value'              => 'Uplaod',
            'after_element_html' => '<br/><br/><small>See <a target="_blank" href="http://help.sweettoothrewards.com/article/323-import-export-points-from-csv-file">documentation</a> for details</small>',
            'tabindex' => 1
        ));
