...
// Modify 404 page
Mage::helper('cls_nucleuscore')->modifyNoRouteCmsPage();

// Install Nucleus Elements example pages/blocks
if (!Mage::helper('cls_nucleuscore/elements')->elementsInstalled()) {
    try {
        Mage::getSingleton('cls_nucleuscore/elements_installer')->doFullInstall();
    } catch (Exception $e) {
        Mage::logException($e);
    }
}