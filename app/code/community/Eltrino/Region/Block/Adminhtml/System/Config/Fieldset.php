    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            'add_button',
            $this->getLayout()->createBlock('eltrino_region/adminhtml_widget_button')->setData(
                array(
    ...
    public function getCountriesDisabledRegions()
    {
        ...
        $data = Mage::getSingleton('eltrino_region/entity')->fetchCountriesDisabledRegions($scope['scope_id'], $scope['scope']);
