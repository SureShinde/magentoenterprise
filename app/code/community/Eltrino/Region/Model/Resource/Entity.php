...
class Eltrino_Region_Model_Resource_Entity extends Mage_Core_Model_Mysql4_Abstract
{
     ...
     * @return $this
     */
    public function storeCountriesDisabledRegions($scope, $scopeId, array $regions = array())
    {
        $data = array();
    ...
    {
        $this->_getWriteAdapter()->delete($this->getMainTable(), array('scope = ?' => $scope, 'scope_id = ?' => $scopeId));
    }
