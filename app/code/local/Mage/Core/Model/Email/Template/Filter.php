...
class Mage_Core_Model_Email_Template_Filter extends Varien_Filter_Template
{
    ...
    {
        $params = $this->_getIncludeParameters($construction[2]);
        ##Begin Edit - Andrej Krupenin <andrej.krupenin@classyllama.com> - Fix native bug in Magento when all media URLs are generated insecured
            return Mage::getBaseUrl('media', Mage::app()->getStore()->isCurrentlySecure()) . $params['url'];
        ##End Edit
    }
