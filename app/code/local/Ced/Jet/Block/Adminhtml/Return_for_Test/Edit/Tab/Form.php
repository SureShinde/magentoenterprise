                           ...
                           $fieldset1 = $fieldset->addFieldset("sku_return_".$i,array('legend'=>Mage::helper('jet')->__('sku : '.$detail['merchant_sku'])));
                              ...
                              if($flag){
                                    $fieldset1->addField('want_to_return'.$i, 'hidden', array(
                                      'label'     => Mage::helper('jet')->__('Want to Send'),
                                     'readonly' => true,
                                     ...
                                     $fieldset1->addField('want_to_return'.$i, 'select', array(
                                      ...
                                      'value'=>$detail["want_to_return"],
                                      'note'=>'If select Yes than data of current sku is sended to Jet.com for return otherwise not.',
                             ...
                             $fieldset1->addField('qty_returned'.$i, 'text', array(
                                ...
                                'note'=>'Quanitity of the given item that was returned.',
                              ));
                              ...
                              'function checkamount'.$i.'(ele){ var am='.$detail["return_principal"].';var amount=(am !="" ? am : 0);if(ele.value==0){document.getElementById("amount'.$i.'").value=0;}else{document.getElementById("amount'.$i.'").value=amount;}}</script>';
