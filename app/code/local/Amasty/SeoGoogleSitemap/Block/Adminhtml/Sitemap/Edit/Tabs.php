    ...
    protected function _beforeToHtml()
    {
        ...
        if (Mage::helper('core')->isModuleEnabled('Amasty_Shopby')
            ...
            $this->addTab('brands', array(
                'label' => Mage::helper('amseogooglesitemap')->__('Improved Navigation Brand Pages'),
                'title' => Mage::helper('amseogooglesitemap')->__('Improved Navigation Brand Pages'),
            ...
            $this->addTab('navigation', array(
                'label' => Mage::helper('amseogooglesitemap')->__('Improved Navigation Pages'),
                'title' => Mage::helper('amseogooglesitemap')->__('Improved Navigation Pages'),
                'content' => $this->getLayout()->createBlock('amseogooglesitemap/adminhtml_sitemap_edit_tab_navigation')->toHtml(),
            ));
        }
