...
function add_coupon_code(add_coupon_url) {
    ...
    //paymentLoad(); change by Huy @smart osc - not reload payment method after apply couppon code @ 16/12/2016
    reviewLoad();
    var request = new Ajax.Request(add_coupon_url, {
        ...
        onSuccess: function (transport) {
            ...
            if (response.error) {
                ...
                // change by Huy @smart osc - not reload payment method after apply couppon code @ 05/12/2016
    ...
    var request = new Ajax.Request(add_coupon_url, {
        ...
        onSuccess: function (transport) {
            ...
            if (response.error) {
                ...
                save_address_information(save_address_url, 1, 0, 1);
                // save_address_information(save_address_url, 1, 1, 1);
                // change by Huy @smart osc - not reload payment method after apply couppon code @ 16/12/2016
                $('coupon_code_onestepcheckout').value = '';
                $('remove_coupon_code_button').hide();
